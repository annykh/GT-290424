...
-- Вывести имена, фамилии и возраст пользователей и из Берлина, и из Бремена
...
-- Вывести имена, фамилии, возраст и телефонные номера(если они указаны) всех пользователей из Бремена и Берлина
...
-- as - alias - временное имя(псевдоним) поля

-- select first_name as name, last_name as surname, age, null as information, 0 as salary, 'lalala'
-- from user_bremen;
...
-- Вывести имена и фамилии сотрудников и имена их департаментов.
...
-- Вывести имена, фамилии, зарплаты и имена департаментов тех сотрудников, которые зарабатывают больше 10000
...
-- Вывести имена и фамилии сотрудников из департаментов Sales и Finance.
...
-- Вывести имена, фамилии и зарплаты сотрудников из депарамента IT, которые зарабатывают больше 5000.
...
-- Вывести имена, фамилии, название департаментов и города, где находтся департаменты.
...
-- Вывести имена и фамилии сотурдников, департаменты которых находятся в городе 'Seattle'
select first_name, last_name
from employees
join departments
on employees.department_id = departments.department_id
...
-- Вывести имена и фамилии сотрудников, названия департаментов в которых они работают, города и страны в которых находятся эти департаменты.
...
on lct.country_id = cnt.country_id;
